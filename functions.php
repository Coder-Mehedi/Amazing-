<?php
/**
 * amazing functions and definitions
 *
...
if ( ! function_exists( 'amazing_setup' ) ) :
	...
	function amazing_setup() {
		 ...
		 * If you're building a theme based on amazing, use a find and replace
		 * to change 'amazing' to the name of your theme in all the template files.
		 */
...
function amazing_scripts() {
	...
	wp_enqueue_script( 'amazing-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'amazing-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
